...
### Code Mode（代码模式）
- **背景色**: `hsl(240 10% 8%)` - 深灰色
- **前景色**: 浅色文字 `hsl(240 5% 90%)`
...
:root {
  ...
  /* Code Mode 颜色 */
  --code-background: 240 10% 8%;
  --code-foreground: 240 5% 90%;
  --code-card: 240 10% 12%;
  --code-muted: 240 10% 15%;
  --code-border: 240 10% 20%;
}
```
